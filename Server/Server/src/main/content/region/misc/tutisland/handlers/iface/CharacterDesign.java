...
public final class CharacterDesign {
	...
	private static final Item[] STARTER_PACK = new Item[] { new Item(1351, 1), new Item(590, 1), new Item(303, 1), new Item(315, 1), new Item(1925, 1), new Item(1931, 1), new Item(2309, 1), new Item(1265, 1), new Item(1321, 1), new Item(1307, 1), new Item(1171, 1), new Item(841, 1), new Item(882, 25), new Item(556, 55), new Item(558, 50), new Item(555, 45), new Item(557, 30), new Item(554, 15), new Item(559, 2) };
	private static final Item[] STARTER_BANK = new Item[] { new Item( 995, 50)};
