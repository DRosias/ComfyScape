...
public enum Lamps {
	...
	MUSEUM_CLEANING(new Item(11185), 500, 10),
	MUSEUM_KUDOS_1(new Item(11186), 1000, 20),
	MUSEUM_KUDOS_2(new Item(11187), 1000, 20),
	MUSEUM_KUDOS_3(new Item(11188), 1000, 20),
	MUSEUM_MINAS(new Item(11189), 10000, 50),
