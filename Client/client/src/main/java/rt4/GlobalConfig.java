...
public class GlobalConfig {
	...
	//region Comfyscape-compatibility Configuration
	@OriginalMember(owner = "client!um", name = "V", descriptor = "Ljava/math/BigInteger;")
	public static final BigInteger RSA_MODULUS = new BigInteger("");
	...
	// Server IP
	public static String DEFAULT_HOSTNAME = "danny-games.servegame.com";

	// Jagex had this at 40000+id
	public static int DEFAULT_PORT = 43594;

	// Jagex had this at 50000+id/443
	public static int ALTERNATE_PORT = 43594;
